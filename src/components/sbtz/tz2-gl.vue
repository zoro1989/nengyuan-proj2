  ...
  export default {
    ...
    methods: {
      ...
      onSearch() {
        this.loading = true
        this.tableData = []
        fetch('get', api.sbGlList, {system_id: this.system_id, nian: this.date}).then((res) => {
          this.rList = res.data
          this.loading = false
        }).catch(() => {
          this.loading = false
      ...
      onSave(formName) {
        this.$refs[formName].validate((valid) => {
            if (valid) {
              this.loading = true
              fetch('post', api.sbGlCreate, {system_id: this.form.system_id, nian: this.form.date, file: this.importFile}).then(() => {
