    ...
    <div class="menu">
      <ul class="mcd-menu">
        ...
        <li>
          ...
          <ul>
            <li><a href="#"><i class="fa fa-hourglass-start"></i>产值综合能耗分析</a></li>
            <li><a href="#"><i class="fa fa-tint"></i>产值耗水量分析</a></li>
            <li><a href="#"><i class="fa fa-battery-half"></i>能源消耗总量分析</a></li>
            <li><a href="#"><i class="fa fa-truck"></i>单车综合能耗分析</a></li>
